                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text('© 2024 AURA FASHION AI', style: TextStyle(fontSize: 10, color: AppColors.textLight.withOpacity(0.5), letterSpacing: 0.5)),
                              Row(
                                children: [
                                  Text('SUPPORT', style: TextStyle(fontSize: 10, color: AppColors.textLight.withOpacity(0.5), letterSpacing: 0.5)),
                                  const SizedBox(width: 16),
                                  Text('PRIVACY', style: TextStyle(fontSize: 10, color: AppColors.textLight.withOpacity(0.5), letterSpacing: 0.5)),
                                ],
                              )
                            ],
                          ),
